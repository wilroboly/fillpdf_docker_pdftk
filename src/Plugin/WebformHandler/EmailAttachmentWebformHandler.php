 ...
 * @WebformHandler(
 *   id = "email_attachment",
 *   label = @Translation("Email with Attachments"),
 *   category = @Translation("Notification"),
 *   description = @Translation("Sends a webform submission along with an attachment via an email."),
 ...
 * )
 */
class EmailAttachmentWebformHandler extends WebformHandlerBase implements WebformHandlerMessageInterface {
   ...
   * Default option value.
   *
   * @see \Drupal\fillpdf_docker_pdftk\Plugin\WebformHandler\EmailWebformHandler::getMessageEmails
   */
